...
<h4>
  ...
  <span> · </span>
    <a href="https://github.com/jeffjiang13/Spotify-Clone/issues">Report Bug</a>
  <span> · </span>
    <a href="https://github.com/jeffjiang13/Spotify-Clone/issues">Request Feature</a>
  </h4>
</div>
...
<a href="https://github.com/jeffjiang13/Spotify-Clone/blob/master/package.json" target="_blank">🔶 Other Dependency Info</a>
...
```bash
  git clone https://github.com/jeffjiang13/Spotify-Clone.git
```
